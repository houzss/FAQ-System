...
image=canvas.create_image(200,150,image=photo)
...
def QAsys():
    ...
    #背景图片
    window_QA_canvas=tk.Canvas(window_QA,height=300,width=450)
...
def usr_sign_up():
    ...
    window_sign_up_canvas=tk.Canvas(window_sign_up,height=200,width=350)
...
def Admin():
    ...
    #背景图片
    window_Admin_canvas=tk.Canvas(window_Admin,height=300,width=450)
    ...
    def add():
        ...
        window_add_canvas=tk.Canvas(window_add,height=200,width=350)
...
def admin_login():
    ...
    window_admin_login_canvas=tk.Canvas(window_admin_login,height=300,width=450)
